...
class TemplateHelper {
   ...
   */
  static loadHandlebarsHelpers(helperFilePath) {
    // Map the file
    const helperFile = require(helperFilePath);
    // If it's non-null, it existed. So, let's fire off the loader!
    if (helperFile) helperFile.loadHandlebarsHelpers(handlebars);
  }
}

// Expose the cache of compiled templates
TemplateHelper.cacheCompiledTemplates = cacheCompiledTemplates;
// Expose our main class
